<template>
    <section id="education" class="relative mt-28 md:justify-between items-center justify-center md:gap-7 gap-20">
        <TextTitle tag="h2" class="mb-6 w-fit">Education</TextTitle>

...
export const aboutMeContents: AboutMeItem[] = [
  ...
  },
  {
    key: 2,
    tag: "Origin",
    title: "Warcraft 3 and Inspired to Become a Programmer",
...
export const portofolio: PortofolioItem[] = [
  ...
  },
  {
    ...
    at: "Cara-Instan (Self Project)",
    imageUrl: "/images/trackdot-main.png",
    date: "2024 - Present",
    skills: [
      "csharp",
      ".NET 8",
    ...
    description:
      "A lightweight Windows system tray utility for global media playback control, time-synced lyrics with Japanese Furigana/Romaji, floating karaoke HUD, and Discord Rich Presence via local IPC.",
    directLinks: {
      github: "https://github.com/Cara-Instan/TrackDot",
      demo: "https://github.com/Cara-Instan/TrackDot/releases",
    },
    detailAction: "/portofolio/trackdot",
  },
  {
    key: 11,
    title: "DevDot",
    ...
    at: "Cara-Instan (Self Project)",
    imageUrl: "/images/devdot-main.png",
    date: "2024 - Present",
    skills: [
      "tauriv2",
      "rust",
    ...
    description:
      "A privacy-first, zero-telemetry universal developer toolkit engineered with Tauri v2, Vue 3, and Rust. Features an offline JSON suite, JWT debugger, crypto/ID generators, cURL transpilers, and PII log redactor. Deployed live on web for daily team use while desktop compilation is refined.",
    directLinks: {
      github: "https://github.com/Cara-Instan/DevDot",
      demo: "https://dev-dot.herlandro.my.id",
    },
    detailAction: "/portofolio/devdot",
  },
];
